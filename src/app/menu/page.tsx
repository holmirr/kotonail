    ...
    <>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gradient-to-br from-purple-50 to-indigo-50 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
              <div className="text-center">
                ...
                <div className="text-center">
                  <span className="text-3xl font-bold text-purple-600">¥6,500</span>
                  <p className="text-sm text-gray-500 mt-2">約110分</p>
                </div>
              </div>
            </div>

            <div className="bg-gradient-to-br from-indigo-50 to-pink-50 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
              <div className="text-center">
                ...
                <div className="text-center">
                  <span className="text-3xl font-bold text-indigo-600">¥6,000</span>
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center p-8 bg-gradient-to-br from-indigo-50 to-pink-50 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <span className="text-2xl font-bold text-indigo-600">¥4,000</span>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          <Link
            href="/contact"
            className="inline-block bg-gradient-to-r from-pink-500 to-purple-600 text-white px-8 py-4 rounded-full text-lg font-semibold hover:from-pink-600 hover:to-purple-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
          >
            ご予約・お問い合わせ
          </Link>
        </div>
